...
Officer: 5909588
CaseNum: 303-0-87583575-5909588
...
The first safe is in Torvald’s office. Crack it by doing the following:
	...
	- Make SecureVaultComb_A equal to 18

	When the mouse button is pressed:
	- Make SecureVaultComb_A equal to 8

	Whilst the mouse is being dragged:
	- Make SecureVaultComb_A equal to 2

	When the mouse button is released:
	- Make SecureVaultComb_A equal to 19

	When any key is released:
	- Make SecureVaultComb_B equal to 25

	When any key is pressed:
	- Make SecureVaultComb_B equal to 1

	When the mouse button is released:
	- Make SecureVaultComb_B equal to 71

	Whilst the mouse is moving:
	- Make SecureVaultComb_B equal to 36
...
var SecureVaultComb_A;
var SecureVaultComb_B;
...
function mouseReleased()
{
    ...
    SecureVaultComb_A=19;
    SecureVaultComb_B=71;
}
...
function keyReleased()
{
    ...
    SecureVaultComb_A=18;
    SecureVaultComb_B=25;
}
...
function draw()
{
	...
	drawDial(200, SecureVaultComb_A, 24);
	pop();

	//Draw the lever
	push();
	translate(width - 125,256);
	drawLever(SecureVaultComb_B);
	pop();
